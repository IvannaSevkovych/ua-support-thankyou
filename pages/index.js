            ...
            <div className={styles.container}>
                ...
                <main className={styles.container}>
                    ...
                    <div className={styles.blue__wrapper}>
                        ...
                        <AnimatePresence exitBeforeEnter={true}>
                            <motion.div key={router.asPath} className={styles.blue__foreground} variants={textTransition} initial="hidden" animate="enter" exit="exit">
                    ...
                    <div className={styles.yellow__wrapper}>
                        <AnimatePresence exitBeforeEnter={true}>
                            <motion.div key={router.asPath} className={styles.subtitle__wrapper} variants={textTransition} initial="hidden" animate="enter" exit="exit">
                        ...
                        <AnimatePresence exitBeforeEnter={true}>
                            <motion.div key={router.asPath} className={styles.links__wrapper} variants={textTransition} initial="hidden" animate="enter" exit="exit">
                                {
